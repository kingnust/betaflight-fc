...
#if defined(ESPFC_TARGET_DRONE_PROTO)
#define ESPFC_SERIAL_2_TX 38
#define ESPFC_SERIAL_2_RX 39
#else
...
#define ESPFC_MTF02P_DEV Serial1
#define ESPFC_MTF02P_TX 41
#define ESPFC_MTF02P_RX 42
#define ESPFC_MTF02P_BAUD 115200
#else
...
#if !defined(CONFIG_FREERTOS_UNICORE) && !defined(ESPFC_DRONE_PROTO_SINGLE_LOOP)
